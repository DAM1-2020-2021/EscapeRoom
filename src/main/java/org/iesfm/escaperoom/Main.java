...
public class Main {
    ...
    public static void main(String[] args) {
        String welcomeMsg  = "Te atreves a completar el desafío de EscapeRoom"
        log.info("Dime tu nombre de usuario: ");
        String name = sc.next();
        ...
        EscapeRoom escapeRoom  = new EscapeRoom(name, welcomeMsg, questions, );

        log.info("Mucha suerte " + name);
        if (gameIsFinish(name) == true){
            log.info(name + " has completado nuestro desafío.");
            log.info("FELICIDADES");
        }
    }
}
